...
public class CreateDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// create the objects
			Instructor tempInstructor = new Instructor("Zaeem", "Kazmi", "zaeem@zk.com");
			InstructorDetail tempInstructorDetail = new InstructorDetail("http://zk.com/youtube", "Luv 2 code!!!");
			
//			Instructor tempInstructor = new Instructor("Madhu", "Patel", "madhu@zk.com");
